...
c
     ...
     &        maxobsperevent 
      parameter(ieq=4500)      ! number of earthquakes (Simultaneous mode)
cs      parameter(ieq=1)        ! number of earthquakes (single event mode ONLY)
     ...
     &          ist=200,      ! max. number of stations in stationlist
     &          maxobsperevent=200) ! max. number of observations per event
c
c
c-----------------------------------------------------------------------------
c
...
cabek  quality class iqc,iwt0,iwt1,iwt2,iwt3,iwt4,iwt5
cabek  obs weights   iqf,iwf0,iwf1,iwf2,iwf3,iwf4
      integer icoordsystem,itrial,ised,isingle,itopo,iturbo,
     &        lowveloclay,ielev,iuseelev,iusestacorr,
     &        iqc,iwt0,iwt1,iwt2,iwt3,iwt4,iwt5,iqf
      real    iwf0,iwf1,iwf2,iwf3,iwf4
      real    ztrial
cabek               iqc,iwt0,iwt1,iwt2,iwt3,iwt4,iwt5
cabek               iqf,iwf0,iwf1,iwf2,iwf3,iwf4
